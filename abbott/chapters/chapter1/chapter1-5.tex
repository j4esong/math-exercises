...
\begin{solution}
  \enum{
  \REPLACE
  \item Assume, for contradiction, that $C\cap[a, 1]$ is countable for all $a\in(0, 1)$. Now $$C=\bigcup^{\infty}_{n=1} C\cap[\frac{1}{n}, 1] = C\cap[0,1]$$ is a countable union of countable sets, which implies that $C$ is countable. However, this cannot be possible because $C$ is uncountable.
  \item \TODO
